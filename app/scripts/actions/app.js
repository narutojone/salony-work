...
export function getProductByID(query: string): Object {
  return {
...
export function getProduct(query: string): Object {
  return {
...
export function getServicesByID(query: string): Object {
  return {
    type: ActionTypes.GET_SERVICESBYID,
    payload: { query },
  };
}
