        ...
        >
          ...
          <main className="app__main">
            <Switch>
              ...
              <RoutePrivate isAuthenticated={user.isAuthenticated} path="/main" component={Main} />
              <RoutePrivate isAuthenticated={user.isAuthenticated} path="/product/:id" exact component={Product} />
